...
@section('content')
    ...
    <ul class="nav nav-tabs" id="bookingsByStatus" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="accepted-tab" data-toggle="tab" href="#accepted" role="tab" aria-controls="accepted" aria-selected="false">Prihvaćene</a>
        </li>
    ...
    <div class="tab-content" id="bookingByStatusContent">
        <div class="tab-pane fade show active" id="accepted" role="tabpanel" aria-labelledby="accepted-tab">
            @include('admin.booking.lists.accepted', [
                'bookings' => $accepted,
                'showActions' => false,
                'showRouteName' => 'trainer.bookings.show',
            ])
        </div>
